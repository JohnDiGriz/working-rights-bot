...
2. З цією інформацією звернутися на Урядову <b>гарячу лінію: 1545</b>. 
...
❗️ Повідомляємо, що безпідставна невиплата заробітної більше як за місяць ━ <b>це злочин</b>, який карається згідно статті 175 Кримінального кодексу України (далі ━ ККУ). В такому випадку слід звертатися до поліції. 

❗️ Якщо відбувається неповна виплата зарплати, то працедавця можна притягнути <b>до адмінвідповідальності</b> згідно статті 41 Кодексу України про адміністративні правопорушення (далі ━ КУпАП). Цим займається Держпраці. 

❗️ Також "Соціальний рух" <b>може висвітлити ваш кейс в інформаційному просторі</b>, якщо ви назвете підприємство і кількість працівників, перед якими є борг. Постарайтеся також зібрати документальні свідоцтва відмови вашого працедавця виплачувати зарплату - скріншоти листування в месенджерах, фото письмової вимоги до керівника тощо.

Якої позиції дотримуватися на переговорах з працедавцем?

Якщо працедавець відмовляється йти вам назустріч, спробуйте пояснити йому, що <b>затягування вирішення проблеми не в його інтересах</b>.

Працівник може вимагати компенсації втрати частини доходів у зв'язку зі зростанням індексу споживчих цін. Якщо на момент звільнення у працедавця буде борг по виплатам зарплат, то згідно статей 116, 117 Кодексу законів про працю України (далі ━ КЗпП) буде нараховуватися компенсація за затримку розрахунку. Якщо ці кошти працівникові не виплачуються, то вони можуть бути стягнені у суді.

Окрім того, можна вимагати притягнення працедавця до кримінальної відповідальності, якщо невиплата зарплати триває понад місяць (стаття 175 ККУ). Цим займається поліція. Якщо ознак злочину немає, то органи Держпраці можуть скласти адмінпротокол за невиплату зарплати на підставі статті 41 КУпАП. Проте покарання визначає суд.

Отже, за даних умов оперативно вплинути на працедавця не можна. Проте сам факт заборгованості працівники можуть використати у майбутньому. Відтак, в інтересах працедавця розрахуватися з працівниками, <b>бо час працює проти нього</b>.""",
...
Якщо робота підприємства стала неможливою та працедавець хоче скоротити вас чи ліквідувати підприємство, він повинен виплатити вам вихідну допомогу. Відповідно п. 1 ст. 40 КЗпП у разі ліквідації підприємства або припинення ФОП, скорочуючи штат, працедавці повинні <b>попередити працівників за 2 місяці та виплатити вихідну допомогу</b> у розмірі одного місячного заробітку (ст. 44 КЗпП). Кошти на це вони повинні знайти самі. 

Якщо працедавець не хоче ліквідувати підприємство або скорочувати співробітників, він повинен оголосити простій згідно зі статтею 34, 113 КЗпП України. Цей режим роботи передбачає <b>виплату зарплати у ⅔ від тарифної сітки</b>.""",
                      "Працедавець відмовляється виплачувати понаднормові/нічні/будь-які інші види доплат": 
                       """На період воєнного стану <b>не скасовуються</b> ані доплати за надурочні, ані за роботу вночі.
...
<b>Важливо!</b> Допомога виплачується особам, які проживають на територіях, де ведуться бойові дії. Список таких територій визначає ДСНС (https://dsns.gov.ua/). На даний момент це такі області: Чернігівська, Сумська, Харківська, Херсонська, Миколаївська, Запорізька, Донецька, Луганська, Житомирська, Одеська, Волинська, Київська та місто Київ.  
...
Ті самі гарантії надаються добровольцям ТрО. Згідно з частиною другою статті 24 Закону України „Про основи національного спротиву” на членів добровольчих формувань територіальних громад під час їх участі у заходах підготовки добровольчих формувань територіальних громад, а також виконання ними завдань територіальної оборони поширюються гарантії соціального і правового захисту, передбачені Законом України „Про соціальний і правовий захист військовослужбовців та членів їх сімей”""",
                      "Я евакуювався_лась / втратив_ла зв'язок із працедавцем / не можу потрапити на робоче місце через бойові дії": """Якщо ви не можете потрапити на робоче місце, але при цьому роботу можна продовжити в дистанційному режимі - через інтернет та інші засоби зв'язку - може перевести співробітника на віддалену роботу не змінюючи трудового договору, для цього достатньо розпорядження керівника (стаття 60-2 КЗпП).

Якщо ж працівник не може вийти на роботу через бойові дії, то він <b>не може бути звільнений або відправлений у відпустку заднім числом</b>. Роботодавець повинен вважати це відсутністю на робочому місці з поважних причин і не має права ставити в табелі обліку використання робочого місця позначки про прогул, а також зобов'язаний виплачувати заробітну плату у повному обсязі.
...
def receive_complaint(update, context):
    if update.message.text in basic_responses:
      update.message.reply_text(basic_responses[update.message.text], parse_mode=ParseMode.HTML)
    else:
